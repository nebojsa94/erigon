...
import (
	...
	"github.com/nebojsa94/erigon/consensus/bor/contract"
	...
	kv2 "github.com/nebojsa94/erigon/erigon-lib/kv/mdbx"
	"github.com/nebojsa94/erigon/erigon-lib/kv/remotedb"
	...
	"github.com/nebojsa94/erigon/cmd/rpcdaemon/graphql"
	"github.com/nebojsa94/erigon/cmd/rpcdaemon/health"
...
func RootCommand() (*cobra.Command, *httpcfg.HttpCfg) {
	...
	rootCmd.PersistentFlags().StringSliceVar(&cfg.API, "http.api", []string{"eth", "erigon"}, "API's offered over the RPC interface: eth,erigon,web3,net,debug,trace,txpool,db. Supported methods: https://github.com/nebojsa94/erigon/tree/devel/cmd/rpcdaemon")
