...
with open('/Users/alexeyakhunov/workspace/src/github.com/nebojsa94/erigon/badger.log') as f:
    lines = f.readlines()
...
with open('/Users/alexeyakhunov/workspace/src/github.com/nebojsa94/erigon/badger.csv', 'w') as w:
